            ...
            <table className="table">
              ...
              <tbody>
                ...
                ${(order.order_status === "Pending") ? "text-yellow-500 text-sm" :
                        ...
                        <td><div className={`badge badge-md badge-outline ${order.payment_status == "Pending" ? "text-yellow-500 text-sm" :
          ...
          {!orderDataLoading ? " " :
              ...
              <table >
                <tbody>
                  ...
                  <tr>
                    <td>Order Price</td>
                    <td className="px-2">:</td>
                    <td className="font-semibold"><span>₹</span>{  (orderData?.item?.price) + "/-" || "N/A"}</td>
                    <td className="px-2 lg:px-4 xl:px-4"></td>
                  </tr>
                  <tr>
            ...
            p-[8px]`}>{orderData.order_status}</td>
                  ...
                  <tr>
                    ...
                    <td className="px-2">:</td>
                    <td className={`badge badge-md badge-outline ${orderData.payment_status == "Pending" ? "text-yellow-500 text-sm" :
